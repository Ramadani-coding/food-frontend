  ...
  return (
    <div className="hero">
      <section className="bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xxl px-3 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-12 lg:px-12 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <a
              href="#order"
              className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-amber-900 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
            >
              Order Now
              <svg
